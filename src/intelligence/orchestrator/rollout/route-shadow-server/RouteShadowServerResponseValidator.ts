/**
 * @fileoverview Response validation for Phase 6.2 real HTTP server smoke tests.
 */
...
export function validateRouteShadowServerResponse(response: RouteShadowServerResponse): RouteShadowServerResponseValidation {
  ...
  return Object.freeze({
    ...
    reasons: reasons.length > 0 ? Object.freeze(reasons) : Object.freeze(['Real HTTP server response is JSON-safe and production-safe.']),
  });
}

function validationVerdict(valid: boolean, body: Record<string, unknown>): RouteShadowServerVerdict {
