/**
 * @fileoverview Metrics for Phase 5.8 staging rehearsal results.
 */
...
export function calculateStagingRehearsalMetrics(
...
function count(
  results: readonly StagingRehearsalFlowResult[],
  predicate: (result: StagingRehearsalFlowResult) => boolean
): number {
